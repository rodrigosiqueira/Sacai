...
bool ChessBoard :: findGeometry(cv::Mat& _source,
                                ...
                                cv::Size& _sizePattern)
{
  ...
  found = cv::findChessboardCorners(_source,_sizePattern,_output,
  ...
  if(found)
  {
    ...
    cv::cornerSubPix(viewGray, _output, cv::Size(11,11), cv::Size(-1, -1),
